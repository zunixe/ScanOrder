...
AS $$
  -- coalesce(..., false): sesi tanpa JWT (service role dll) harus dapat
  -- FALSE eksplisit, bukan NULL (yang membuat guard IF lolos).
...
-- ============================================================
-- 2b. RPC DAFTAR USER: admin_list_users()
-- CATATAN: auth.users.email bertipe VARCHAR → WAJIB cast ::text,
-- kalau tidak RETURN QUERY error 42804 (structure mismatch).
-- ============================================================
